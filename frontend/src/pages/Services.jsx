...
// Load CSS specifically for Services page
      ...
      <main style={{ overflowX: 'hidden' }}>
        ...
        <section className="section" aria-label="Services list">
          <div className="container">
            ...
            <div className="service-block" data-reveal="true">
              ...
              <div className="service-block-body">
                ...
                <Link to="/contact" className="service-block-link">Start a Branding Project <i className="ri-arrow-right-line"></i></Link>
              </div>
            ...
            <div className="service-block" data-reveal="true">
              ...
              <div className="service-block-body">
                ...
                <Link to="/contact" className="service-block-link">Start a Web Project <i className="ri-arrow-right-line"></i></Link>
              </div>
              <div className="service-deliverables">
                <h5 className="deliverables-title">Deliverables</h5>
                <ul>
            ...
            <div className="service-block" data-reveal="true">
              ...
              <div className="service-block-body">
                ...
                <Link to="/contact" className="service-block-link">Start a Video Project <i className="ri-arrow-right-line"></i></Link>
              </div>
              <div className="service-deliverables">
                <h5 className="deliverables-title">Deliverables</h5>
                <ul>
        ...
        <section className="section" style={{ background: 'var(--surface)', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)' }} aria-labelledby="process-heading">
          <div className="container">
            ...
            <div className="section-header">
              <div className="section-label" data-reveal="true"><span className="t-label">The Process</span></div>
            ...
            <div className="process-grid">
              <div className="process-step" data-reveal="true" data-delay="1"><div className="process-num" aria-hidden="true">01</div><h3 className="process-title">Discover</h3><p className="process-desc">Understanding your business, your audience, your goals, and your gap. Before a single pixel is placed, we get aligned on what the work needs to achieve.</p></div>
              <div className="process-step" data-reveal="true" data-delay="2"><div className="process-num" aria-hidden="true">02</div><h3 className="process-title">Define</h3><p className="process-desc">Shaping the strategy, the creative direction, and the deliverables. This is where ambiguity becomes clarity — and where we agree on what success looks like.</p></div>
              <div className="process-step" data-reveal="true" data-delay="3"><div className="process-num" aria-hidden="true">03</div><h3 className="process-title">Design</h3><p className="process-desc">Crafting the work with precision, creativity, and intention at every step. Revisions are part of the process. The goal is to get it right — not just done.</p></div>
              <div className="process-step" data-reveal="true" data-delay="4"><div className="process-num" aria-hidden="true">04</div><h3 className="process-title">Deliver</h3><p className="process-desc">Handing over production-ready files, a live build, or final assets — with full documentation and support. The project isn't done until you're confident.</p></div>
            </div>
          </div>
        </section>
