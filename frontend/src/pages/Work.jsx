...
// Load CSS specifically for Work page
          ...
          <div className="work-main-inner">
            ...
            <div className="work-grid" id="workGrid">
              <div className="work-item" data-reveal="true" data-category="Branding" data-delay="1">
                <Link to="/case-study/branding" className="project-card" aria-label="Apex — Brand Identity">
                  ...
                  <div className="card-overlay"><h3 className="card-title">Apex — Brand Identity</h3><p className="card-sub">Visual system · Strategy · Guidelines</p></div>
