...
function BrandingPageContent() {
  ...
  const getEmptyState = (): BrandProject => ({
    ...
    caseStudyHero: {
      heroBgImage: "", heroTitle: "", heroSector: "", heroDeliverables: "", heroDeliverablesLink: "", heroHookRichText: ""
    },
    dynamicBlocks: []
  });
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (!slug) {
          ...
          // Edit Mode
          const project = data.find((p: BrandProject) => p.id === slug); // fallback for safety
          if (project) {
  ...
  const pageTitle = slug ? `Edit: ${projectData.caseStudyHero.heroTitle || projectData.gridPreview.gridTitle || 'Project'}` : "Create New Branding Project";
            ...
            <input
              ...
              onChange={(e) =>
                setProjectData({
                  ...
                  caseStudyHero: {
                    ...projectData.caseStudyHero,
                    heroDeliverables: e.target.value,
                  },
                })
              }
            ...
            <input
              ...
              onChange={(e) =>
                setProjectData({
                  ...
                  caseStudyHero: {
                    ...projectData.caseStudyHero,
                    heroDeliverablesLink: e.target.value,
                  },
                })
              }
              placeholder="https://..."
